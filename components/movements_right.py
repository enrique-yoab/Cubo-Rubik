...
def move_F_right(cube):
    #se mueve la cara principal, a la derecha 1 y el color principal es 2 que es el blanca
    cube = move_face(cube,1,2)
    ...
    #obtenemos el renglon afectado de la cara naranja
    ren0 = []
    ren5 = []
    ren1 = []
    ren3= []
    ...
    #obtenemos la columna afectada de la cara azul
    #obtenemos la columna afectada de la cara verde
...
def move_R_right(cube):
    #se rota la cara verde ya que ahora es la cara principal
    #se rota a la derecha 1 y el color es 3 para verde
    cube = move_face(cube,1,3)
    #se agregan las 4 caras que se modifican al rotar
...
def move_U_right(cube):
    #se rota la cara roja ya que ahora es la principal
    #se rota a la derecha 1 y el color es 0 para rojo
    cube = move_face(cube,1,0)
...
def move_B_right(cube):
    #se rota la cara amarilla ya que ahora es la principal
    #se rota a la derecha 1 y el color es 4 para amarillo
    cube = move_face(cube,1,4)
...
def move_L_right(cube):
    #se rota la cara azul ya que ahora es la principal
    #se rota a la derecha 1 y el color es 1 para azul
    cube = move_face(cube,1,1)
...
def move_D_right(cube):
    #se rota la cara narnaja ya que ahora es la principal
    #se rota a la derecha 1 y el color es 5 para naranja
    cube = move_face(cube,1,5)
